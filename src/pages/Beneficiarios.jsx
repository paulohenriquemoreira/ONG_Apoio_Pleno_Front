      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          >
            ...
            <span className="break-words">Gestão de Beneficiários</span>
          </h1>
        ...
        <button
          ...
          className="w-full sm:w-auto bg-blue-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-blue-700 transition flex items-center justify-center gap-2 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none"
        >
            ...
            <tbody className="divide-y divide-slate-200 text-sm text-slate-700">
              {beneficiarios.map((item) => (
                ...
                >
                  ...
                  {/* Adicionado break-words para evitar corte de texto longo */}
                  <td className="p-4 font-medium text-slate-900 break-words max-w-[200px]">
                    {item.nome}
                  </td>
                  <td className="p-4 break-words">{item.documento}</td>
                  <td className="p-4 break-words">{item.telefone}</td>
                  <td className="p-4 text-center">
                    <div className="flex justify-center gap-2">
                      <button
                        onClick={() => abrirEdicao(item)}
                        className="text-blue-600 hover:text-blue-800 p-2 rounded-full hover:bg-blue-50 transition focus:ring-2 focus:ring-blue-300"
                      ...
                      <button
                        ...
                        className="text-red-600 hover:text-red-800 p-2 rounded-full hover:bg-red-50 transition focus:ring-2 focus:ring-red-300"
